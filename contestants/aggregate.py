...
Outputs:
  - contestants/ranking.json — full ranked data
  - contestants/ranking.md   — human-readable ranking
"""
...
(ROOT / 'ranking.json').write_text(json.dumps(all_scores, indent=2))

# Markdown report
lines = ['# APL 2026 — Final Ranking', '']
